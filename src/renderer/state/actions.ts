...
export function buildAppActions({
  ...
  const actions: AppAction[] = [
    ...
    },
    {
      ...
      description: 'Search, test, pin, and inspect available tools',
      keywords: ['tools', 'catalog', 'pin', 'health', 'availability', 'cli', 'mcp'],
      run: () => openSettings('tools'),
    },
    {
      id: 'system:apps',
      group: 'system',
      icon: 'settings',
      label: 'Open apps and integrations',
      description: 'Manage Codex plugins, apps, skills, and MCP providers',
  ...
  if (openRightRail) {
    ...
    actions.push(
      ...
      },
      {
        ...
        icon: 'tools',
        label: 'Show tools',
        description: 'Open curated tool health and activity in the right rail',
        keywords: ['rail', 'right rail', 'tools', 'health', 'activity', 'availability'],
        disabledReason: needsRepo,
