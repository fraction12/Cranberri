...
const api = {
  ...
  codex: {
    ...
    respondToServerRequest: (response: import('@/shared/codex-requests').CodexHumanServerRequestResponse) => ipcRenderer.invoke('codex:server-request:respond', response),
    listServerRequests: (threadId?: string) => ipcRenderer.invoke('codex:server-requests:list', { threadId }),
    ...
    pickRuntime: () => ipcRenderer.invoke('codex:runtime:pick'),
    reloadRuntime: () => ipcRenderer.invoke('codex:runtime:reload'),
  ...
  tasks: {
    ...
    archive: (taskId: string): Promise<import('@/shared/tasks').TaskLifecycleResult> => ipcRenderer.invoke('tasks:archive', { taskId }),
    unarchive: (taskId: string): Promise<import('@/shared/tasks').TaskLifecycleResult> => ipcRenderer.invoke('tasks:unarchive', { taskId }),
