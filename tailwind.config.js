    ...
    extend: {
      colors: {
        app: {
          ...
          'text-secondary': 'rgb(var(--app-text-secondary-rgb) / <alpha-value>)',
          'text-tertiary': 'rgb(var(--app-text-tertiary-rgb) / <alpha-value>)',
          'text-disabled': 'rgb(var(--app-text-disabled-rgb) / <alpha-value>)',
          ...
          'status-success': 'rgb(var(--app-status-success-rgb) / <alpha-value>)',
          'status-warning': 'rgb(var(--app-status-warning-rgb) / <alpha-value>)',
          'status-info': 'rgb(var(--app-status-info-rgb) / <alpha-value>)',
          'status-danger': 'rgb(var(--app-status-danger-rgb) / <alpha-value>)',
          'danger-fill': 'rgb(var(--app-danger-fill-rgb) / <alpha-value>)',
          'danger-fill-hover': 'rgb(var(--app-danger-fill-hover-rgb) / <alpha-value>)',
          'on-danger': 'rgb(var(--app-on-danger-rgb) / <alpha-value>)',
